...
python3 unified_orchestrator.py --controller_type noresnet --desired_trajectory 1 --wind

BEST RUNS (OUTSIDE DOCKER)
python3 run_best_gains.py --desired_trajectory 1 --wind

PREPARING FOR A REAL-WORLD EXPERIMENT ONLY:
...
INSIDE DOCKER ON QUAD (REAL-WORLD EXPERIMENT)
cd /home/root
...
RUN:
ros2 run aviary_rise_controller aviary_rise_controller --ros-args --params-file /home/root/humble_ws/src/aviary_rise_controller/param/noresnet_params.yaml
...
ros2 run aviary_rise_controller aviary_rise_controller --ros-args --params-file /home/root/humble_ws/src/aviary_rise_controller/param/developed_params.yaml