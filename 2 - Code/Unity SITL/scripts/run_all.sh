...
python scripts/run_optimization.py --stage 2A --num_trials $TRIALS_PHASE_2 --db_dir $DB_DIR --patience $PATIENCE
...
python scripts/run_optimization.py --stage 2B --num_trials $TRIALS_PHASE_2 --db_dir $DB_DIR --patience $PATIENCE
